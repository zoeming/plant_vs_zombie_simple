...
public class GamePlay extends JPanel{
	...
	public static void main(String[] args) {
		...
		// 音效
		String path = GamePlay.class.getResource("").getPath();

		while(true){
			switch (state){
				// 游戏开始音效
				case 0:
					Runnable r0 = new zombieAubio(path + "start.wav");
				...
				// 游戏进行音效
				case 1:
					Runnable r1 = new zombieAubio(path + "runing.wav");
				...
				// 游戏失败音效
				case 2:
					Runnable r2 = new zombieAubio(path + "gameover.wav");
